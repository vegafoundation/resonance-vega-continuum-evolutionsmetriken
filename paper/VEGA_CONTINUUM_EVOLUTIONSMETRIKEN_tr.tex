...
\title{VEGA CONTINUUM EVOLUTIONSMETRIKEN: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, VEGA CONTINUUM EVOLUTIONSMETRIKEN'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
